...
import com.lolay.citygrid.ads.tracking.TrackingActionTarget;
import com.lolay.citygrid.ads.tracking.TrackingClient;
import com.lolay.citygrid.ads.tracking.TrackingInvoker;
...
public class TrackingIntegration extends TestCase {
	...
	public void testImpression() throws Exception {
		...
		TrackingInvoker invoker = TrackingInvoker.builder().listingId(1).referenceId(1).impressionId("1").actionTarget(TrackingActionTarget.LISTING_PROFILE)
